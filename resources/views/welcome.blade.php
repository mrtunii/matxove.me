...
<div id="main">
    <div id="slide-out-left" class="side-nav">
        <div class="top-left-nav">
            <div class="searchbar"><i class="fa fa-search"></i><input type="text" placeholder="Search"></div>
        </div>
        <div id="main-menu">
            <ul>
                <li><a href="index.html"><i class="fa fa-home"></i> Home</a></li>
                <li class="has-sub">
                    <a href="#"><i class="fa fa-th-list"></i> Categories</a>
                    <ul>
                ...
                <li class="has-sub">
                    <a href="#"><i class="fa fa-shopping-basket"></i> Checkout</a>
                    <ul>
                ...
                <li class="has-sub">
                    <a href="#"><i class="fa fa-google-wallet"></i> Order</a>
                    <ul>
                ...
                <li class="has-sub">
                    <a href="#"><i class="fa fa-users"></i> Member</a>
                    <ul>
                ...
                <li class="has-sub">
                    <a href="#"><i class="fa fa-file-text-o"></i> Blog</a>
                    <ul>
    ...
    <div id="slide-out-right" class="side-nav">
        ...
        <div class="sidebar-tabs_content">
            <div id="yourcart">
                <ol class="cart-item">
                    <li>
                        <div class="thumb"><img src="images/shop8_80x80.png" alt=""></div>
                        <div class="cart-delete"><a href="#"><i class="fa fa-times"></i></a></div>
                        <div class="cart-detail">
                            <h3 class="product-name"><a href="product.html">Tablet Mini 2</a></h3>
                            <div class="price"><span>Price</span> $ 472.5</div>
                            <div class="qty"><span>Qty</span> <input type="number" value="1"></div>
                        </div>
                    </li>
                    <li>
                        <div class="thumb"><img src="images/shop3_65x65.png" alt=""></div>
                        <div class="cart-delete"><a href="#"><i class="fa fa-times"></i></a></div>
                        <div class="cart-detail">
                            <h3 class="product-name"><a href="product.html">Modern Watch</a></h3>
                            <div class="price"><span>Price</span> $ 260.9</div>
                            <div class="qty"><span>Qty</span> <input type="number" value="1"></div>
                        </div>
                    </li>
                    <li>
                        <div class="thumb"><img src="images/shop2_65x65.png" alt=""></div>
                        <div class="cart-delete"><a href="#"><i class="fa fa-times"></i></a></div>
                        <div class="cart-detail">
                            <h3 class="product-name"><a href="product.html">Camping Tent</a></h3>
                            <div class="price"><span>Price</span> $ 102.8</div>
                            <div class="qty"><span>Qty</span> <input type="number" value="1"></div>
                        </div>
                    </li>
                </ol>
                <div class="cart-action">
                    <div class="subtotal"><span class="title">Subtotal</span><span class="price">$ 835.2</span></div>
                    <div class="subtotal"><span class="title">Tax</span><span class="price">$ 4.0</span></div>
                    <div class="total"><span class="title">Total</span><span class="price">$ 839.2</span></div>
                    <a href="#" class="btn green btn-block">Proceed to checkout</a>
                </div>
            </div>
            <div id="latestblog">
                <div class="latest-blog-featured">
                    <div class="thumb"><img src="images/feat1.jpg" alt=""></div>
    ...
    <div id="page">
        <div class="top-navbar">
            ...
            <div class="top-navbar-right">
                <a href="#" class="dropdown-button" data-activates="dropdown1"><i class="fa fa-user-circle-o"></i></a>
                ...
                <a href="#" id="menu-right" data-activates="slide-out-right"><span class="cart-badge">3</span><i class="fa fa-shopping-basket"></i></a>
            </div>
        ...
        <div class="content-container">
            ...
            <div class="shofy-form">
                ...
                <div class="input-field">
                    ...
                    <input type="text" id="amount" placeholder="Your Acc No"><input type="text" id="amount" placeholder="Your ACC Name (Match with Bank passbook)">
                </div>
                <div class="input-field">
                ...
                <div class="input-field">
                    ...
                    <div class="file-field">
                        <div class="btn grey"><span>File</span><input type="file"></div>
                        <div class="file-path-wrapper"><input class="file-path validate" type="text"></div>
                    </div>
                </div>
                <button class="btn block green" type="button">Send</button>
            </div>
        </div>
        <div class="footer">
            <div class="footer-main">
                <p><span class="block text-small">Secure shopping at shofy via</span><i class="fa fa-cc-amex"></i><i class="fa fa-cc-mastercard"></i><i class="fa fa-credit-card"></i><i class="fa fa-cc-paypal"></i><i class="fa fa-cc-visa"></i><i class="fa fa-google-wallet"></i><i class="fa fa-cc-discover"></i><i class="fa fa-cc-jcb"></i></p>
                <p><span class="block text-small">Having problem? Contact us</span>+44 567 89 | ours@example.com | <a href="#">Live Chat</a></p>
                <div class="social-footer"><a href="#" class="facebook"><i class="fa fa-facebook"></i></a><a href="#" class="twitter"><i class="fa fa-twitter"></i></a><a href="#" class="gplus"><i class="fa fa-google-plus"></i></a></div>
            </div>
            <div class="copyright">
                <span class="block">&copy; 2016 Shofy Inc - Mobile Shop Template</span>
                <div class="navigation"><a href="#">Term & Condition</a><a href="#">Privacy Policy</a></div>
            </div>
        </div>
